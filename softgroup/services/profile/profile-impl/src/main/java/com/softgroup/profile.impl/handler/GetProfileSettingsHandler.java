...
@Component
public class GetProfileSettingsHandler <T extends GetProfileSettingsRequest, R extends GetProfileSettingsResponse> extends AbstractRequestHandler<T, R> implements ProfileRequestHandler {
    @Override
